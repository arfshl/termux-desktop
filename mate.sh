...
# Install MATE
apt install -y tigervnc termux-x11 pulseaudio dbus mate-* marco mate-terminal caja 

cat <<'EOF' > /data/data/com.termux/files/usr/bin/startdesktop-mate
#!/bin/sh
...
echo 'To start termux-x11 session use startdesktop-mate command'
